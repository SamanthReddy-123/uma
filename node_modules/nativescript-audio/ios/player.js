...
var TNSPlayerDelegate = /** @class */ (function (_super) {
    ...
    TNSPlayerDelegate.prototype.audioPlayerDidFinishPlayingSuccessfully = function (player, flag) {
    ...
    TNSPlayerDelegate.prototype.audioPlayerDecodeErrorDidOccurError = function (player, error) {
        var owner = this._owner.get();
        if (owner) {
